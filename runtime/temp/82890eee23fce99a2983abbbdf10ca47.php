<?php /*a:3:{s:67:"/www/wwwroot/api.xcdah.cn/application/admin/view/post/postList.html";i:1644046912;s:60:"/www/wwwroot/api.xcdah.cn/application/admin/view/header.html";i:1644046912;s:60:"/www/wwwroot/api.xcdah.cn/application/admin/view/footer.html";i:1644046912;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="mdui-appbar-with-toolbar">
        <div class="mc-appbar mdui-appbar mdui-appbar-fixed">
            <div class="mdui-toolbar">
                ...
                <a href="javascript:;" class="mdui-typo-title min-display">文章列表</a>
...
<script>
    ...
    $('.loading').show();
    $.ajax({
        url: "<?php echo url('post/getList'); ?>" + "?page=" + getQueryVariable("page"),
        type: "get",
        dataType: "json",
