<?php /*a:3:{s:65:"/www/wwwroot/api.xcdah.cn/application/admin/view/api/apiList.html";i:1644046912;s:60:"/www/wwwroot/api.xcdah.cn/application/admin/view/header.html";i:1644046912;s:60:"/www/wwwroot/api.xcdah.cn/application/admin/view/footer.html";i:1644046912;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="mdui-appbar-with-toolbar">
        <div class="mc-appbar mdui-appbar mdui-appbar-fixed">
            <div class="mdui-toolbar">
                ...
                <a href="javascript:;" class="mdui-typo-title min-display">接口列表</a>
...
<script>
    ...
    $(".loading").show();
    $.ajax({
        url: "<?php echo url('api/getList'); ?>" + "?page=" + getQueryVariable("page"),
        type: "get",
        dataType: "json",
